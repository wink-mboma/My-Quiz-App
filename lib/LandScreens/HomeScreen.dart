              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        Image.asset(
                          'assets/images/hour-glasses.png',
                          height: 40,
                        ),
                        Text(
                          'Weekly Quiz starts in : 24:40 hrs',
                          style: TextStyle(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        'All the quizzes that are ready to be taken are available ',
                        style: TextStyle(
                          color: Colors.white,
                          fontFamily: 'Quicksand',
                        ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        'below. They can be played anytime you feel ready',
                        style: TextStyle(
                          color: Colors.white,
                          fontFamily: 'Quicksand',
                        ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        'We can easily assist you get into the  following universities',
                        style: TextStyle(
                          color: Colors.white,
                          fontFamily: 'Quicksand',
                        ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        'Get latest news about examination updates from',
                        style: TextStyle(
                          color: Colors.white,
                          fontFamily: 'Quicksand',
                        ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        'the Britih Council and Ministry of Education.',
                        style: TextStyle(
                          color: Colors.white,
                          fontFamily: 'Quicksand',
                        ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      'exam series for centers running ',
                                      style: TextStyle(
                                        color: Colors.black87,
                                        fontFamily: 'Quicksand',
                                        fontSize: 10,
