...
class SubjectQuestionRightScreen extends StatefulWidget {
  @override
  _SubjectQuestionRightScreenState createState() =>
      _SubjectQuestionRightScreenState();
}

class _SubjectQuestionRightScreenState
    extends State<SubjectQuestionRightScreen> {
  int _currentIndex = 0;
  int _counter = 0;
