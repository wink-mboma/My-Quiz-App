...
import 'package:sygne_quiz/SubjectScreen/SubjectQuestionRightScreen.dart';
...
class SubjectQuestionWrongScreen extends StatefulWidget {
  @override
  _SubjectQuestionWrongScreenState createState() =>
      _SubjectQuestionWrongScreenState();
}

class _SubjectQuestionWrongScreenState
    extends State<SubjectQuestionWrongScreen> {
  int _currentIndex = 0;
  int _counter = 0;
